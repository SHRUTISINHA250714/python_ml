...
# df = pd.read_csv("https://github.com/SHRUTISINHA250714/python_ml/blob/main/hardware_inventory_realistic_prices.csv")
...
try:
    # Load dataset (ensure the file path or URL is correct)
    df = pd.read_csv("https://github.com/SHRUTISINHA250714/python_ml/blob/main/hardware_inventory_realistic_prices.csv")
    ...
    # Train the model
    price_model = RandomForestRegressor(n_estimators=10, random_state=42)
    price_model.fit(X_train, y_train)
